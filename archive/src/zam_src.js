...
function getFormatDraftRow(data) {
  ...
  //      og: data[8],
          ibu: +data[9],
          filter_names: [data[10]],
          untuppd: null
      };
    
    if (!!data[11])
        obj.filter_names.push(data[11]);
    ...
    var type_rub = device.mobile()? "р" : " руб.";
        obj[ TYPES[0] ] = "";
        obj[ TYPES[1] ] = data[5] + type_rub;
        obj[ TYPES[2] ] = data[6] + type_rub;
        obj[ "info-"+TYPES[0] ] = {cost: data[4], cost_id: 0};
        obj[ "info-"+TYPES[1] ] = {cost: data[5], cost_id: 1};
        obj[ "info-"+TYPES[2] ] = {cost: data[6], cost_id: 2};
...
function showDraftFilters (filters, filters_choose) { 
  ...
  setVisibleFilterBtn (filters, filters_choose, "крепче 9%", "btn-draft-hard");
  setVisibleFilterBtn (filters, filters_choose, "фруктовое", "btn-draft-fruit");
  setVisibleFilterBtn (filters, filters_choose, "классика", "btn-draft-classic");
  setVisibleFilterBtn (filters, filters_choose, "сидр/медовуха", "btn-draft-nobeer");
  setVisibleFilterBtn (filters, filters_choose, "необычное", "btn-draft-other");
  ...
  setVisibleFilterBtn (filters, filters_choose, "пшеничное", "btn-draft-weizen");
    setVisibleFilterBtn (filters, filters_choose, "томатное", "btn-draft-tomato");
    setVisibleFilterBtn (filters, filters_choose, "суп", "btn-draft-soup");
...
function getFiltersChooseDraft () {
  ...
  if ($("[name=btn-draft-weizen]").is(':visible') & $("[name=btn-draft-weizen]").hasClass("btn-success"))
    ...
    if ($("[name=btn-draft-tomato]").is(':visible') & $("[name=btn-draft-tomato]").hasClass("btn-success"))
        filters_choose.push("томатное");
    if ($("[name=btn-draft-soup]").is(':visible') & $("[name=btn-draft-soup]").hasClass("btn-success"))
        filters_choose.push("суп");
...
function filterDraft (isclearfilterbrewery) {
  ...
  for (var i = 0; i < draftData.length; i++) {
    ...
    if (filters_choose.indexOf(draftData[i].filter_names[0]) > -1 || filters_choose.indexOf(draftData[i].filter_names[1]) > -1) {
    	if (brewery) {
...
function showBottleFilters (filters, filters_choose) { 
  ...
  setVisibleFilterBtn (filters, filters_choose, "крепче 9%", "btn-bottle-hard");
  setVisibleFilterBtn (filters, filters_choose, "фруктовое", "btn-bottle-fruit");
  setVisibleFilterBtn (filters, filters_choose, "классика", "btn-bottle-classic");
  setVisibleFilterBtn (filters, filters_choose, "сидр/медовуха", "btn-bottle-nobeer");
  setVisibleFilterBtn (filters, filters_choose, "необычное", "btn-bottle-other");
  ...
  setVisibleFilterBtn (filters, filters_choose, "пшеничное", "btn-bottle-weizen");
    setVisibleFilterBtn (filters, filters_choose, "томатное", "btn-bottle-tomato");
    setVisibleFilterBtn (filters, filters_choose, "суп", "btn-bottle-soup");
...
function getFiltersChooseBottle () {
  ...
  if ($("[name=btn-bottle-classic]").is(':visible') & $("[name=btn-bottle-classic]").hasClass("btn-success"))
    filters_choose.push("классика");
  if ($("[name=btn-bottle-nobeer]").is(':visible') & $("[name=btn-bottle-nobeer]").hasClass("btn-success"))
    filters_choose.push("сидр/медовуха");
  ...
  if ($("[name=btn-bottle-weizen]").is(':visible') & $("[name=btn-bottle-weizen]").hasClass("btn-success"))
    ...
    if ($("[name=btn-bottle-tomato]").is(':visible') & $("[name=btn-bottle-tomato]").hasClass("btn-success"))
        filters_choose.push("томатное");
    if ($("[name=btn-bottle-soup]").is(':visible') & $("[name=btn-bottle-soup]").hasClass("btn-success"))
        filters_choose.push("суп");
...
function filterBottle (isclearfilterbrewery) {
  var 
   ...
   for (var i = 0; i < bottleData.length; i++) {
    ...
    if (filters_choose.indexOf(bottleData[i].filter_names[0]) > -1 || filters_choose.indexOf(bottleData[i].filter_names[1]) > -1) {
    	if (brewery) {
