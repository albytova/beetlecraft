...
//$GLOBALS['FLUD_CHAT_ID'] = '-771483710';
        ...
        "inline_keyboard" => array(
            array(
                array(
                    ...
                    "url" => "https://t.me/+TbphwLNehLlmOTZi"
                )
            )
        )
    );
...
function processingPhoto ($data, $db) {
    ...
    //Отправка в чат
    $_result = $db->query("select is_public_photo from barhopping where user_name='".$GLOBALS['USER']."'") or die('Connection Error: ' . $db->connect_error);
    $set = array();
