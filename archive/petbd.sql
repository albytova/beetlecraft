...
INSERT INTO `action` VALUES ('Elena Albytova','order_new_amount|67|bottle_05');
...
INSERT INTO `contractor_cost` VALUES (1,5,1,6),(2,5,2,7),(3,5,3,8.2),(4,5,4,9),(5,6,3,9);
...
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb4 AVG_ROW_LENGTH=8192;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order` VALUES (64,5,'1','0',NULL,'2023-11-26',NULL,1,NULL),(68,6,'0','0',NULL,'2024-01-09',NULL,0,NULL);
...
--
-- Temporary table structure for view `storage_get_bottle`
--

DROP TABLE IF EXISTS `storage_get_bottle`;
/*!50001 DROP VIEW IF EXISTS `storage_get_bottle`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `storage_get_bottle` (
  `id` tinyint NOT NULL,
  `id_product` tinyint NOT NULL,
  `all` tinyint NOT NULL,
  `reserv` tinyint NOT NULL,
...
--
-- Final view structure for view `storage_get_bottle`
--

/*!50001 DROP TABLE IF EXISTS `storage_get_bottle`*/;
/*!50001 DROP VIEW IF EXISTS `storage_get_bottle`*/;
...
/*!50013 DEFINER=`craft`@`188.162.200.239` SQL SECURITY INVOKER */
/*!50001 VIEW `storage_get_bottle` AS select `storage`.`id` AS `id`,`storage`.`id_product` AS `id_product`,`storage`.`all` AS `all`,`storage`.`reserv` AS `reserv`,`product`.`name` AS `name`,`product`.`dist` AS `dist` from (`storage` join `product` on((`storage`.`id_product` = `product`.`id`))) where (`product`.`name` like 'bottle%') */;
...
-- Dump completed on 2024-12-16 17:02:02
