...
function getFormatDraftRow(data) {
  ...
  var TYPES = [
    ...
    let type_rub = device.mobile()? "р" : " руб.";
...
function getDraftRowText (obj) {
  ...
  if (device.mobile()) {
    ...
    text = "<table width=\"100%\" cellspacing=\"0\"><tr>"+
      ...
      "<td colspan=\"2\"><span class=\"draft-name\" ><a href='#' onclick='loadUntappd("+obj.beer_uid+");return;'>" + obj.name + "</a></span></td>"+
    "</tr>"+
    "<tr>"+
    ...
    text = "<table><tr>"+
              ...
              "<td colspan=\"2\" width=\"100%\"><span class=\"draft-name\"><a href='#' onclick='loadUntappd("+obj.beer_uid+");return;'>" + obj.name + "</a></span>" +
...
function getBottleRowText (obj) {  
  ...
  if (device.mobile()) {
    ...
    text = "<table width=\"100%\">"+
              "<tr>"+
                  "<td colspan=\"2\" width=\"100%\"><span class=\"draft-name\"><a href='#' onclick='loadUntappd("+obj.beer_uid+")'>" + obj.name + "</a></span>" +
                    "<span class=\"draft-style\">[" + obj.style + "]</span>"+
                "</td>"+
              "</tr><tr>"+
                  "<td width=\"40%\">" + 
                      (obj.abv && obj.abv.length > 0? "abv " + obj.abv + "%" : "") +
                      (obj.abv && obj.abv.length > 0 && obj.ibu > 0? " | " : "") +
                      (obj.ibu > 0? "ibu " + obj.ibu : "") + 
                "</td>"+
